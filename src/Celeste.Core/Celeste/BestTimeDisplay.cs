...
public class BestTimeDisplay : Component
{
	...
	public Vector2 RenderPosition => Calc.Round((base.Entity.Position + Position));
	...
	public override void Render()
	{
		if (WillRender)
		{
			...
			renderPosition -= Vector2.UnitY * wiggler.Value * 3f;
			...
			if (icon != null)
			{
				icon.DrawOutlineCentered(renderPosition + new Vector2(-4f, -3f), iconColor);
			}
			ActiveFont.DrawOutline(sTime, renderPosition + new Vector2(0f, 4f), new Vector2(0.5f, 0f), Vector2.One, color, 2f, Color.Black);
		}
	}
}
