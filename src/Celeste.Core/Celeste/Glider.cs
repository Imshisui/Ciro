...
{
	[CompilerGenerated]
	private sealed class _003CDestroyAnimationRoutine_003Ed__38 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;

		private object _003C_003E2__current;

		public Glider _003C_003E4__this;
		...
		[DebuggerHidden]
		public _003CDestroyAnimationRoutine_003Ed__38(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			Glider glider = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
	...
	private void PlayOpen()
	{
		if (sprite.CurrentAnimationID != "fall" && sprite.CurrentAnimationID != "fallLoop")
		{
			...
			level.Particles.Emit(P_Expand, 16, base.Center + Calc.Rotate(Vector2.UnitY * -12f, sprite.Rotation), new Vector2(8f, 3f), -(float)Math.PI / 2f + sprite.Rotation);
			if (Hold.IsHeld)
			{
	...
	[IteratorStateMachine(typeof(_003CDestroyAnimationRoutine_003Ed__38))]
