...
// using Celeste.Editor; // Desabilitado para Android
// using Celeste.Pico8; // Desabilitado para Android
using FMOD.Studio;
...
public static class Commands
{
	...
	private static void CmdMapEdit(int index = -1, int mode = 0)
	{
		...
		//Engine.Scene = new MapEditor(area);  // COMMENTED OUT: MapEditor not available on Android
