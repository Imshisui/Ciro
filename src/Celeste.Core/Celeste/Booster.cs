...
{
	[CompilerGenerated]
	private sealed class _003CBoostRoutine_003Ed__31 : IEnumerator<object>, IDisposable, IEnumerator
	{
		...
		public Booster _003C_003E4__this;
		...
		[DebuggerHidden]
		public _003CBoostRoutine_003Ed__31(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			Booster booster = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
			...
			case 2:
				...
				if ((player.StateMachine.State == 2 || player.StateMachine.State == 5) && booster.BoostingPlayer)
				{
					...
					{
						(booster.Scene as Level).ParticlesBG.Emit(booster.particleType, 2, player.Center - dir * 3f + new Vector2(0f, -2f), new Vector2(3f, 3f), _003Cangle_003E5__2);
					}
			...
			if (booster.SceneAs<Level>().Transitioning)
			{
				_003C_003E2__current = null;
	...
	[IteratorStateMachine(typeof(_003CBoostRoutine_003Ed__31))]
	...
	public override void Render()
	{
		...
		sprite.Position = Calc.FloorV(position);
