...
public class Player : Actor
{
	...
	public struct ChaserState
	{
		...
		public ChaserState(Player player)
		{
			...
			sound0 = ((Sounds > 0) ? activeSounds[0] : default(ChaserStateSound));
			sound1 = ((Sounds > 1) ? activeSounds[1] : default(ChaserStateSound));
			sound2 = ((Sounds > 2) ? activeSounds[2] : default(ChaserStateSound));
			sound3 = ((Sounds > 3) ? activeSounds[3] : default(ChaserStateSound));
			sound4 = ((Sounds > 4) ? activeSounds[4] : default(ChaserStateSound));
		}
	}

	[CompilerGenerated]
	private sealed class _003CDashCoroutine_003Ed__427 : IEnumerator<object>, IDisposable, IEnumerator
	{
		...
		private Vector2 _003CswapCancel_003E5__2;
		...
		[DebuggerHidden]
		public _003CDashCoroutine_003Ed__427(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			...
			Player player = _003C_003E4__this;
			switch (num)
			{
			default:
				return false;
			...
			case 1:
			{
				...
				{
					dir = player.OverrideDashDirection.Value;
				}
				dir = player.CorrectDashPrecision(dir);
				...
				player.gliderBoostDir = (player.DashDir = dir);
				...
				{
					player.level.Particles.Emit(FlyFeather.P_Boost, 12, player.Center, Vector2.One * 4f, (-dir).Angle());
				}
				if (player.onGround && player.DashDir.X != 0f && player.DashDir.Y > 0f && player.Speed.Y > 0f && (!player.Inventory.DreamDash || !player.CollideCheck<DreamBlock>(player.Position + Vector2.UnitY)))
				{
				...
				_003CswapCancel_003E5__2 = Vector2.One;
				foreach (SwapBlock entity in player.Scene.Tracker.GetEntities<SwapBlock>())
				{
					if (player.CollideCheck(entity, player.Position + Vector2.UnitY) && entity != null && entity.Swapping)
					{
						...
						{
							player.Speed.X = (_003CswapCancel_003E5__2.X = 0f);
						}
						if (player.DashDir.Y != 0f && entity.Direction.Y == (float)Math.Sign(player.DashDir.Y))
						{
							player.Speed.Y = (_003CswapCancel_003E5__2.Y = 0f);
						}
					}
				}
				if (SaveData.Instance.Assists.SuperDashing)
			...
			if (player.DashDir.Y <= 0f)
			{
				...
				player.Speed.X *= _003CswapCancel_003E5__2.X;
				player.Speed.Y *= _003CswapCancel_003E5__2.Y;
			}
	...
	[CompilerGenerated]
	private sealed class _003CBoostCoroutine_003Ed__450 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CBoostCoroutine_003Ed__450(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
	...
	[CompilerGenerated]
	private sealed class _003CRedDashCoroutine_003Ed__454 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CRedDashCoroutine_003Ed__454(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
	...
	private sealed class _003C_003Ec__DisplayClass472_0
	{
		...
		internal void _003CPickupCoroutine_003Eb__0(Tween t)
		{
			_003C_003E4__this.carryOffset = curve.GetPoint(t.Eased);
		}
	}

	[CompilerGenerated]
	private sealed class _003CPickupCoroutine_003Ed__472 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		private Vector2 _003ColdSpeed_003E5__2;

		private float _003CvarJump_003E5__3;
		...
		[DebuggerHidden]
		public _003CPickupCoroutine_003Ed__472(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			{
				_003C_003E1__state = -1;
				_003C_003Ec__DisplayClass472_0 CS_0024_003C_003E8__locals3 = new _003C_003Ec__DisplayClass472_0
				{
					_003C_003E4__this = _003C_003E4__this
				};
				player.Play("event:/char/madeline/crystaltheo_lift");
				Input.Rumble(RumbleStrength.Medium, RumbleLength.Short);
				if (player.Holding != null && player.Holding.SlowFall && ((player.gliderBoostTimer - 0.16f > 0f && player.gliderBoostDir.Y < 0f) || (player.Speed.Length() > 180f && player.Speed.Y <= 0f)))
				{
					Audio.Play("event:/new_content/game/10_farewell/glider_platform_dissipate", player.Position);
				}
				_003ColdSpeed_003E5__2 = player.Speed;
				_003CvarJump_003E5__3 = player.varJumpTimer;
				player.Speed = Vector2.Zero;
				Vector2 vector = player.Holding.Entity.Position - player.Position;
				Vector2 carryOffsetTarget = CarryOffsetTarget;
				CS_0024_003C_003E8__locals3.curve = new SimpleCurve(control: new Vector2(vector.X + (float)(Math.Sign(vector.X) * 2), CarryOffsetTarget.Y - 2f), begin: vector, end: carryOffsetTarget);
				player.carryOffset = vector;
				Tween tween = Tween.Create(Tween.TweenMode.Oneshot, Ease.CubeInOut, 0.16f, start: true);
				tween.OnUpdate = delegate(Tween t)
				{
					CS_0024_003C_003E8__locals3._003C_003E4__this.carryOffset = CS_0024_003C_003E8__locals3.curve.GetPoint(t.Eased);
				};
				player.Add(tween);
			...
			case 1:
				_003C_003E1__state = -1;
				player.Speed = _003ColdSpeed_003E5__2;
				player.Speed.Y = Math.Min(player.Speed.Y, 0f);
				player.varJumpTimer = _003CvarJump_003E5__3;
				player.StateMachine.State = 0;
				if (player.Holding != null && player.Holding.SlowFall)
				{
					...
					if (player.onGround && (float)Input.MoveY == 1f)
					{
	...
	[CompilerGenerated]
	private sealed class _003CStarFlyCoroutine_003Ed__509 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CStarFlyCoroutine_003Ed__509(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 3:
			{
				...
				{
					vector = Vector2.UnitX * (float)player.Facing;
				}
				player.Speed = vector * 250f;
				player.starFlyLastDir = vector;
				player.level.Particles.Emit(FlyFeather.P_Boost, 12, player.Center, Vector2.One * 4f, (-vector).Angle());
				Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
	...
	[CompilerGenerated]
	private sealed class _003CFlingBirdCoroutine_003Ed__517 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CFlingBirdCoroutine_003Ed__517(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
	...
	[CompilerGenerated]
	private sealed class _003CCassetteFlyCoroutine_003Ed__524 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CCassetteFlyCoroutine_003Ed__524(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 3:
				...
				IL_0155:
				if (player.cassetteFlyLerp < 1f)
				{
					if (player.level.OnInterval(0.03f))
					{
						player.level.Particles.Emit(P_CassetteFly, 2, player.Center, Vector2.One * 4f);
					}
	...
	[CompilerGenerated]
	private sealed class _003CDummyWalkTo_003Ed__538 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CDummyWalkTo_003Ed__538(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			if (Math.Abs(x - player.X) > 4f && player.Scene != null && (keepWalkingIntoWalls || !player.CollideCheck<Solid>(player.Position + Vector2.UnitX * Math.Sign(x - player.X))))
			{
	...
	[CompilerGenerated]
	private sealed class _003CDummyWalkToExact_003Ed__539 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CDummyWalkToExact_003Ed__539(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			else
			{
				...
				_003Clast_003E5__2 = Math.Sign(player.X - (float)x);
			}
			if (!player.Dead && player.X != (float)x && !player.CollideCheck<Solid>(player.Position + new Vector2((float)player.Facing, 0f)) && (!cancelOnFall || player.OnGround()))
			{
				player.Speed.X = Calc.Approach(player.Speed.X, (float)Math.Sign((float)x - player.X) * 64f * speedMultiplier, 1000f * Engine.DeltaTime);
				int num2 = Math.Sign(player.X - (float)x);
				if (num2 == _003Clast_003E5__2)
				{
					_003Clast_003E5__2 = num2;
					_003C_003E2__current = null;
					_003C_003E1__state = 1;
					return true;
				}
	...
	[CompilerGenerated]
	private sealed class _003CDummyRunTo_003Ed__540 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CDummyRunTo_003Ed__540(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
	...
	[CompilerGenerated]
	private sealed class _003CTempleFallCoroutine_003Ed__543 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CTempleFallCoroutine_003Ed__543(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 2:
				...
				Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
				player.level.DirectionalShake(new Vector2(0f, 1f), 0.5f);
				player.Speed.X = 0f;
				player.level.Particles.Emit(P_SummitLandA, 12, player.BottomCenter, Vector2.UnitX * 3f, -(float)Math.PI / 2f);
				player.level.Particles.Emit(P_SummitLandB, 8, player.BottomCenter - Vector2.UnitX * 2f, Vector2.UnitX * 2f, 3.403392f);
				player.level.Particles.Emit(P_SummitLandB, 8, player.BottomCenter + Vector2.UnitX * 2f, Vector2.UnitX * 2f, -(float)Math.PI / 12f);
				_003Cp_003E5__2 = 0f;
				break;
			}
	...
	[CompilerGenerated]
	private sealed class _003CReflectionFallCoroutine_003Ed__547 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CReflectionFallCoroutine_003Ed__547(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
	...
	[CompilerGenerated]
	private sealed class _003CIntroWalkCoroutine_003Ed__550 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CIntroWalkCoroutine_003Ed__550(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 0:
				_003C_003E1__state = -1;
				_003Cstart_003E5__2 = player.Position;
			...
			case 3:
				...
				IL_00f4:
				if (Math.Abs(player.X - _003Cstart_003E5__2.X) > 2f && !player.CollideCheck<Solid>(player.Position + new Vector2((float)player.Facing, 0f)))
				{
					player.MoveTowardsX(_003Cstart_003E5__2.X, 64f * Engine.DeltaTime);
					_003C_003E2__current = null;
					_003C_003E1__state = 2;
					return true;
				}
				player.Position = _003Cstart_003E5__2;
				player.Sprite.Play("idle");
				_003C_003E2__current = 0.2f;
				_003C_003E1__state = 3;
				return true;
	...
	[CompilerGenerated]
	private sealed class _003CIntroJumpCoroutine_003Ed__551 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		private bool _003CwasSummitJump_003E5__3;
		...
		[DebuggerHidden]
		public _003CIntroJumpCoroutine_003Ed__551(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 0:
				_003C_003E1__state = -1;
				_003Cstart_003E5__2 = player.Position;
				_003CwasSummitJump_003E5__3 = player.StateMachine.PreviousState == 10;
				player.Depth = -1000000;
				player.Facing = Facings.Right;
				if (!_003CwasSummitJump_003E5__3)
				{
				...
				_003Cstart_003E5__2.Y = player.level.Bounds.Bottom - 24;
				player.MoveToX((int)Math.Round(player.X / 8f) * 8);
				goto IL_00fa;
			case 1:
				_003C_003E1__state = -1;
				goto IL_00fa;
			...
			case 8:
				{
					...
					{
						player.Hair.Nodes[i] = new Vector2(0f, 2 + i);
					}
					break;
				}
				IL_0264:
				...
				if (_003CwasSummitJump_003E5__3)
				{
					...
					player.level.Particles.Emit(P_SummitLandB, 8, player.BottomCenter - Vector2.UnitX * 2f, Vector2.UnitX * 2f, 3.403392f);
					player.level.Particles.Emit(P_SummitLandB, 8, player.BottomCenter + Vector2.UnitX * 2f, Vector2.UnitX * 2f, -(float)Math.PI / 12f);
					player.level.ParticlesBG.Emit(P_SummitLandC, 30, player.BottomCenter, Vector2.UnitX * 5f);
				...
				return true;
				IL_0145:
				if (player.Y > _003Cstart_003E5__2.Y - 8f)
				{
	...
	[CompilerGenerated]
	private sealed class _003CIntroMoonJumpCoroutine_003Ed__552 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CIntroMoonJumpCoroutine_003Ed__552(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 1:
				_003C_003E1__state = -1;
				_003C_003E2__current = player.MoonLanding(_003Cstart_003E5__2);
				_003C_003E1__state = 2;
				return true;
			case 2:
				_003C_003E1__state = -1;
	...
	[CompilerGenerated]
	private sealed class _003CMoonLanding_003Ed__553 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CMoonLanding_003Ed__553(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 4:
				...
				IL_008d:
				if (player.Y > groundPosition.Y - 8f)
				{
			...
			if (!player.OnGround())
			{
				player.Speed.Y += Engine.DeltaTime * _003Cs_003E5__2;
				_003Cs_003E5__2 = Calc.Approach(_003Cs_003E5__2, 2f, Engine.DeltaTime * 50f);
				_003C_003E2__current = null;
				_003C_003E1__state = 4;
				return true;
			}
	...
	[CompilerGenerated]
	private sealed class _003CIntroWakeUpCoroutine_003Ed__554 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CIntroWakeUpCoroutine_003Ed__554(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 1:
				_003C_003E1__state = -1;
				_003C_003E2__current = player.Sprite.PlayRoutine("wakeUp");
				_003C_003E1__state = 2;
				return true;
			case 2:
				_003C_003E1__state = -1;
	...
	[CompilerGenerated]
	private sealed class _003CIntroThinkForABitCoroutine_003Ed__558 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		[DebuggerHidden]
		public _003CIntroThinkForABitCoroutine_003Ed__558(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 1:
				...
				_003Ctarget_003E5__2 = player.X + 8f;
				goto IL_00c7;
			case 2:
				_003C_003E1__state = -1;
				goto IL_00c7;
			...
			case 5:
				...
				IL_00c7:
				if (player.X < _003Ctarget_003E5__2)
				{
	...
	[CompilerGenerated]
	private sealed class _003CBirdDashTutorialCoroutine_003Ed__561 : IEnumerator<object>, IDisposable, IEnumerator
	{
		private int _003C_003E1__state;
		...
		private bool _003Cclimbing_003E5__2;
		...
		[DebuggerHidden]
		public _003CBirdDashTutorialCoroutine_003Ed__561(int _003C_003E1__state)
		{
			this._003C_003E1__state = _003C_003E1__state;
		}
		...
		private bool MoveNext()
		{
			...
			case 1:
			{
				_003C_003E1__state = -1;
				player.CreateTrail();
				player.Add(Alarm.Create(Alarm.AlarmMode.Oneshot, player.CreateTrail, 0.08f, start: true));
				player.Add(Alarm.Create(Alarm.AlarmMode.Oneshot, player.CreateTrail, 0.15f, start: true));
			...
			case 8:
				...
				IL_03b2:
				if (player.CollideCheck<Solid>(player.Position + new Vector2(1f, 0f)))
				{
				...
				break;
				IL_02d9:
				if (!player.OnGround() && !_003Cclimbing_003E5__2)
				{
					player.Speed.Y = Calc.Approach(player.Speed.Y, 160f, 900f * Engine.DeltaTime);
					if (player.CollideCheck<Solid>(player.Position + new Vector2(1f, 0f)))
					{
						_003Cclimbing_003E5__2 = true;
					}
					if (player.Top > (float)player.level.Bounds.Bottom)
					{
				...
				if (_003Cclimbing_003E5__2)
				{
					player.Sprite.Play("wallslide");
					Dust.Burst(player.Position + new Vector2(4f, -6f), new Vector2(-4f, 0f).Angle());
					player.Speed.Y = 0f;
					_003C_003E2__current = 0.2f;
					_003C_003E1__state = 4;
					return true;
				...
				{
					player.Speed.X = Calc.Approach(player.Speed.X, 0f, 240f * Engine.DeltaTime);
					if (player.Scene.OnInterval(0.04f))
					{
						Dust.Burst(player.BottomCenter + new Vector2(0f, -2f), (float)Math.PI * -3f / 4f);
					}
					_003C_003E2__current = null;
					_003C_003E1__state = 8;
					return true;
				...
				break;
				IL_01ab:
				if (_003Ctime_003E5__3 < 0.15f)
				{
					if (player.Speed != Vector2.Zero && player.level.OnInterval(0.02f))
					{
						player.level.ParticlesFG.Emit(P_DashA, player.Center + Calc.Random.Range(Vector2.One * -2f, Vector2.One * 2f), player.DashDir.Angle());
					}
					_003C_003E2__current = null;
					_003C_003E1__state = 2;
					return true;
	...
	public Vector2 CameraTarget
	{
		get
		{
			...
			Vector2 vector = new Vector2(base.X - 160f, base.Y - 90f);
			...
			{
				vector.X += 0.2f * Speed.X;
				vector.Y += 0.2f * Speed.Y;
			}
			else if (StateMachine.State == 5)
			{
				vector.X += 48 * Math.Sign(Speed.X);
				vector.Y += 48 * Math.Sign(Speed.Y);
			}
			...
			{
				result.X = MathHelper.Clamp(vector.X, level.Bounds.Left, level.Bounds.Right - 320);
				result.Y = MathHelper.Clamp(vector.Y, level.Bounds.Top, level.Bounds.Bottom - 180);
			}
			else
			{
				result = vector;
			...
			if (level.CameraLockMode != Level.CameraLockModes.None)
			{
				...
				else if (level.CameraLockMode == Level.CameraLockModes.BoostSequence)
				{
					...
					if (component != null)
					{
						result.Y = Math.Max(result.Y, Math.Min(level.Bounds.Bottom - 180, component.Entity.Y - component.MaxYOffset));
					}
				}
			}
			foreach (Entity entity in base.Scene.Tracker.GetEntities<Killbox>())
			{
				...
				{
					result.Y = Math.Min(result.Y, entity.Top - 180f);
				}
			}
			return result;
		}
	...
	public int MaxDashes
	{
		get
		{
			if (SaveData.Instance.Assists.DashMode != Assists.DashModes.Normal && !level.InCutscene)
			{
				return 2;
			}
		...
		: base(new Vector2((int)position.X, (int)position.Y))
	{
		...
		Sprite.OnLastFrame = delegate
		{
			...
			{
				string text = "";
				text = ((Sprite.Mode != PlayerSpriteMode.Madeline) ? idleNoBackpackOptions.Choose() : ((level.CoreMode == Session.CoreModes.Hot) ? idleWarmOptions : idleColdOptions).Choose());
	...
	public override void Render()
	{
		...
		Sprite.RenderPosition = Calc.FloorV(Sprite.RenderPosition);
		...
		else
		{
			...
			{
				float num = (float)Sprite.CurrentAnimationFrame / (float)Sprite.CurrentAnimationTotalFrames;
	...
	public override void Update()
	{
		...
		Vector2 forceStrongWindHair = windDirection;
		if (ForceStrongWindHair.Length() > 0f)
		{
			forceStrongWindHair = ForceStrongWindHair;
		}
		if (windTimeout > 0f && forceStrongWindHair.X != 0f)
		{
			windHairTimer += Engine.DeltaTime * 8f;
			Hair.StepPerSegment = new Vector2(forceStrongWindHair.X * 5f, (float)Math.Sin(windHairTimer));
		...
		else if (Dashes > 1)
		{
			...
			Hair.StepPerSegment.Y += forceStrongWindHair.Y * 2f;
		}
		else
		{
			...
			Hair.StepYSinePerSegment = 0f;
			Hair.StepPerSegment.Y += forceStrongWindHair.Y * 0.5f;
		}
		...
		if (Sprite.CurrentAnimationID != null && Sprite.CurrentAnimationID.Equals("wallslide") && Speed.Y > 0f)
		{
			...
			Platform platformByPriority = SurfaceIndex.GetPlatformByPriority(CollideAll<Solid>(base.Center + Vector2.UnitX * (float)Facing, temp));
			if (platformByPriority != null)
			{
	...
	public void HiccupJump()
	{
		...
		case 19:
			if (Speed.X > 0f)
			{
				Speed = Calc.Rotate(Speed, 0.6981317f);
			}
			else
			{
				Speed = Calc.Rotate(Speed, -0.6981317f);
		...
		case 9:
			if (Speed.X < 0f || (Speed.X == 0f && Speed.Y < 0f))
				{
				Speed = Calc.Rotate(Speed, 0.17453292f);
			}
			else
			{
				Speed = Calc.Rotate(Speed, -0.17453292f);
		...
		else
		{
			...
			if (Speed.Y > 0f)
			{
				...
				if (StateMachine.State != 1)
				{
					...
					Input.Rumble(RumbleStrength.Light, RumbleLength.Short);
					Platform platformByPriority = SurfaceIndex.GetPlatformByPriority(CollideAll<Platform>(Position + new Vector2(0f, 1f), temp));
					int num2 = -1;
					if (platformByPriority != null)
					{
						num2 = platformByPriority.GetLandSoundIndex(this);
						if (num2 >= 0 && !MuffleLanding)
						{
					...
					if (Speed.Y >= 80f)
					{
						Dust.Burst(Position, new Vector2(0f, -1f).Angle(), 8, DustParticleFromSurfaceIndex(num2));
					}
		...
		if (!onGround)
		{
			...
			if ((moveX == (int)Facing || (moveX == 0 && Input.GrabCheck)) && Input.MoveY.Value != 1)
			{
				...
				if (wallSlideDir != 0)
				{
					...
					target = MathHelper.Lerp(160f, 20f, wallSlideTimer / 1.2f);
			...
			Speed.Y = Calc.Approach(Speed.Y, target, 900f * num7 * Engine.DeltaTime);
		}
		if (varJumpTimer > 0f)
		{
	...
	private void DashAssistInit()
	{
		if (SaveData.Instance.Assists.DashAssist && !demoDashed)
		{
			...
			playerDashAssist.Offset = ((CurrentBooster == null && StateMachine.PreviousState != 5) ? Vector2.Zero : new Vector2(0f, -4f));
		}
	}
	...
	[IteratorStateMachine(typeof(_003CDashCoroutine_003Ed__427))]
	private IEnumerator DashCoroutine()
	{
		...
		{
			level.Particles.Emit(FlyFeather.P_Boost, 12, base.Center, Vector2.One * 4f, (-value).Angle());
		}
		...
		foreach (SwapBlock entity in base.Scene.Tracker.GetEntities<SwapBlock>())
		{
	...
	{
		Vector2 vector = Calc.FloorV((boostTarget - base.Collider.Center));
		MoveToX(vector.X);
		MoveToY(vector.Y);
	}
	...
	[IteratorStateMachine(typeof(_003CBoostCoroutine_003Ed__450))]
	...
	[IteratorStateMachine(typeof(_003CRedDashCoroutine_003Ed__454))]
	...
	[IteratorStateMachine(typeof(_003CPickupCoroutine_003Ed__472))]
	...
	[IteratorStateMachine(typeof(_003CStarFlyCoroutine_003Ed__509))]
	private IEnumerator StarFlyCoroutine()
	{
		...
		level.Particles.Emit(FlyFeather.P_Boost, 12, base.Center, Vector2.One * 4f, (-vector).Angle());
		Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
	...
	private int StarFlyUpdate()
	{
		...
		else
		{
			...
			starFlyLoopSfx.Param("feather_speed", (!flag) ? 1 : 0);
	...
	[IteratorStateMachine(typeof(_003CFlingBirdCoroutine_003Ed__517))]
	...
	[IteratorStateMachine(typeof(_003CCassetteFlyCoroutine_003Ed__524))]
	...
	[IteratorStateMachine(typeof(_003CDummyWalkTo_003Ed__538))]
	...
	[IteratorStateMachine(typeof(_003CDummyWalkToExact_003Ed__539))]
	...
	[IteratorStateMachine(typeof(_003CDummyRunTo_003Ed__540))]
	...
	private int TempleFallUpdate()
	{
		...
		if (!onGround)
		{
			...
			int num2 = ((Math.Abs((float)num - base.X) > 4f) ? Math.Sign((float)num - base.X) : 0);
			Speed.X = Calc.Approach(Speed.X, 54.000004f * (float)num2, 325f * Engine.DeltaTime);
		}
		if (!onGround && DummyGravity)
		{
	...
	[IteratorStateMachine(typeof(_003CTempleFallCoroutine_003Ed__543))]
	...
	[IteratorStateMachine(typeof(_003CReflectionFallCoroutine_003Ed__547))]
	...
	[IteratorStateMachine(typeof(_003CIntroWalkCoroutine_003Ed__550))]
	...
	[IteratorStateMachine(typeof(_003CIntroJumpCoroutine_003Ed__551))]
	...
	[IteratorStateMachine(typeof(_003CIntroMoonJumpCoroutine_003Ed__552))]
	...
	[IteratorStateMachine(typeof(_003CMoonLanding_003Ed__553))]
	...
	[IteratorStateMachine(typeof(_003CIntroWakeUpCoroutine_003Ed__554))]
	...
	[IteratorStateMachine(typeof(_003CIntroThinkForABitCoroutine_003Ed__558))]
	...
	[IteratorStateMachine(typeof(_003CBirdDashTutorialCoroutine_003Ed__561))]
	...
	public FMOD.Studio.EventInstance Play(string sound, string param = null, float value = 0f)
	{
		float value2 = 0f;
		if (base.Scene is Level { Raining: not false })
		{
			value2 = 1f;
		}
	...
	{
		string value2 = null;
		SFX.MadelineToBadelineSound.TryGetValue(sound, out value2);
		if (value2 != null)
		{
